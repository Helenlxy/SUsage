	...
	<SCRIPT type="text/javascript">
		...
		var zNodes =[
	 	...
	 	/* Role Purview :: Group Master */
			...
			{ id:12, pId:1, name:"系统后台", open:true},
			{ id:121, pId:12, name:"任务管理"},
			{ id:1211, pId:121, name:"删除任务"},
			{ id:1212, pId:121, name:"发布全局公告"},
			
			{ id:122, pId:12, name:"用户管理"},
			{ id:1221, pId:122, name:"新增用户"},
			{ id:1222, pId:122, name:"用户编辑"},
			{ id:1223, pId:122, name:"用户删除"},
			{ id:1224, pId:122, name:"用户重置密码"},
			
			{ id:123, pId:12, name:"系统管理"},
			{ id:1231, pId:123, name:"用户角色配置（组员/组长）"},
			{ id:1232, pId:123, name:"用户角色配置（管理员/超管）"},
			...
			{ id:2221, pId:222, name:"新增用户"},
			{ id:2222, pId:222, name:"用户编辑"},
			{ id:2223, pId:222, name:"用户删除"},
			{ id:2224, pId:222, name:"用户重置密码"},
			
			{ id:223, pId:22, name:"系统管理"},
			{ id:2231, pId:223, name:"用户角色配置（组员/组长）"},
			{ id:2232, pId:223, name:"用户角色配置（管理员/超管）"},
			...
			{ id:3221, pId:322, name:"新增用户"},
			{ id:3222, pId:322, name:"用户编辑"},
			{ id:3223, pId:322, name:"用户删除"},
